...
export default class Funcionalidades extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllFuncionalidadess();
  }
  ...
  public retrieveAllFuncionalidadess(): void {
  ...
  public prepareRemove(instance: IFuncionalidades): void {
  ...
  public removeFuncionalidades(): void {
    this.funcionalidadesService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('proyecto03App.funcionalidades.deleted', { param: this.removeId });
